        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card">
                    ...
                    @if(session('message'))
                        <div class="alert alert-success alert-dismissible fade show ms-4" style="width: 60%"
                            role="alert">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                                    ...
                                    <div class="md-3 mt-2">
                                        ...
                                        <input type="text" name="smaill_description"
                                            value="{{ $product->smaill_description }}" class="form-control">
                                    </div>
                                    <div class="md-3 mt-2">
                                ...
                                <div class="tab-pane fade" id="seotag-tab-pane" role="tabpanel"
                                    ...
                                    <div class="md-3 mt-2">
                                        ...
                                        <textarea name="meta_keyword" class="form-control" cols="30"
                                            rows="2">{{ $product->meta_keyword }}</textarea>
                                    </div>
                                    <div class="md-3 mt-2">
                                                ...
                                                @foreach($product->productImage as $image)
                                                    <div class="col-md-2">
                                                        <img src="{{ asset($image->image) }}" alt="img"
                                                            ...
                                                            class="me-4 border border-danger mt-2" />
                                                        <a class="d-block mt-1"
                                                            href="{{ url('/dashboard/product-image/'.$image->id.'/delete') }}">Remove</a>
                                                    </div>
                                                @endforeach
                                            </div>
                                        @else
                                                ...
                                                <div class="col-md-3">
                                                    <div class="p-2 border mb-2">
                                                        ...
                                                        Quantity: <input type="number"
                                                            ...
                                                            style="border: 1px solid; width:75px" />
                                                    </div>
                                                </div>
                                            @empty
                                                <md-3>
